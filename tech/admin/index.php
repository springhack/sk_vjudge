<?php /**
        ...
        Last modified: 2015-10-11 20:06:06
        ...
        <div id="container">
            ...
            <div id="right">
                <div id="left">
                    ...
                    <div class="item_parent" onclick="menu.open('order.php')">
                        <img src="img/order.svg" />订单管理
                    </div>
                    <div class="item_parent" onclick="menu.open('talk.php')">
                        <img src="img/talk.svg" /><?php
                        	if ($user->getPower() == 0)
								echo "评论管理";
							else
								echo "我的评论";
